...
## To do
- See docs/roadmap.md (company pages, US map, better at-a-glance parsing).
...
- Phase 3: Andy's own SWE jobs. Maybe: free AI pass for missed fields; optional email digest.
